...
const PRODUCTOS_INICIALES = {
  secos: {
    ...
    orden: 1,
    productos: [
      { id: 1, nombre: "Cookie Pecán", precio: 180, imagen: "" },
      { id: 2, nombre: "Cookie Avellanas", precio: 180, imagen: "" },
      { id: 3, nombre: "Cookie Pistacho", precio: 200, imagen: "" },
      { id: 4, nombre: "Cookie Shot", precio: 160, imagen: "" },
      { id: 5, nombre: "Scón de Queso", precio: 220, imagen: "" },
      { id: 6, nombre: "Chipa", precio: 150, imagen: "" },
      { id: 7, nombre: "Alfajor Manteca", precio: 280, imagen: "" },
      { id: 8, nombre: "Alfajor Maicena", precio: 280, imagen: "" },
      { id: 9, nombre: "Alfajor Almendra", precio: 320, imagen: "" },
      { id: 10, nombre: "Alfajor Pistacho", precio: 350, imagen: "" },
      { id: 11, nombre: "Alfajor Berrylate", precio: 300, imagen: "" },
      { id: 12, nombre: "Financier Pistacho", precio: 380, imagen: "" },
      { id: 13, nombre: "Financier Frutos Rojos", precio: 360, imagen: "" },
    ],
  },
  minicakes: {
    nombre: "Minicakes",
